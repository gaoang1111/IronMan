...
OUTPUT_DIR=${OUTPUT_DIR:-../checkpoints/phase-cmp-residual}

# RESUME_PATH=${RESUME_PATH:-../checkpoints/phase2/phase2_step_390}
RESUME_PATH=${RESUME_PATH:-../checkpoints/phase-warmup-2query-residual/phase1_step_60}
...
# RESUME_PATH=${RESUME_PATH:-../checkpoints/phase-cmp/phase-cmp_step_300}
...
LR=${LR:-3e-5}
LR_PROJECTOR=${LR_PROJECTOR:-3e-5} 
LR_GENERATOR=${LR_GENERATOR:-5e-6}
LR_COMPRESSOR=${LR_COMPRESSOR:-3e-5}
...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-Mark-33-phase-cmp-2query-residual}
WANDB_RUN_TAGS=${WANDB_RUN_TAGS:-phase-cmp,2query,javis,attn,residual}
